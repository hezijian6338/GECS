...
<ul class="nav nav-tabs">
	<li class="active"><a href="${ctx}/license/businessLicense/">营业执照注销列表</a></li>
	...
	<c:forEach items="${page.list}" var="businessLicense">
		<tr>
			...
			<shiro:hasPermission name="license:businessLicense:edit"><td>
				...
				<a href="${ctx}/license/businessLicense/delete?id=${businessLicense.id}" onclick="return confirmx('确认要删除该营业执照吗？', this.href)">注销</a>
