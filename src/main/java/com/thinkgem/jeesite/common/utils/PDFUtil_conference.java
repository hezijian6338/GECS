 ...
 */
public class PDFUtil_conference {
...
//    public static final String CHARACTOR_FONT_CH_FILE = "C:\\Users\\Administrator\\Desktop\\graduate\\Graduation\\src\\main\\resources\\SIMHEI.TTF";  //黑体常规
    ...
    public static void fillTemplate(CertificateConference certificateConference, String path, String outputFileName)
...
//        under.addImage(image);
        ...
        double sumSg = 0;
        int personNum = certificateConference.getCertificateConferenceSubList().size();
        for (int i=0 ; i < personNum; i++){
            if ("1".equals(certificateConference.getCertificateConferenceSubList().get(i).getAttendState())){
                sumSg += Double.valueOf(certificateConference.getCertificateConferenceSubList().get(i).getSg());
            }
        }
 ...
 /*       //证照编号 注入
        ...
        //以下是会议决议：
        //公司名
        s.setField("idcompanyNameTitle", fillSpace(certificateConference.getCompanyName(),10 , isNull(s,"idcompanyNameTitle")));

        //会议通知时间
        s.setField("idconferenceInformTime", fillSpace( df.format(certificateConference.getConferenceInformTime()),10 , isNull(s,"idconferenceInformTime")));

        //会议通知方式
        s.setField("idconferenceInformType", fillSpace(certificateConference.getConferenceInformType() ,10 , isNull(s,"idconferenceInformType")));

        //会议时间
        s.setField("idconferenceTime", fillSpace(df.format(certificateConference.getConferenceTime()) ,10 , isNull(s,"idconferenceTime")));

        //会议地点
        s.setField("idconferenceAddr", fillSpace(certificateConference.getConferenceAddr(),10 , isNull(s,"idconferenceAddr")));
        ...
        //
        s.setField("idname3", fillSpace(certificateConference.getCertificateConferenceSubList().get(0).getName() ,10 , isNull(s,"idname3")));

        //
        s.setField("idname4", fillSpace(certificateConference.getCertificateConferenceSubList().get(0).getName()  ,10 , isNull(s,"idname4")));

        //
        s.setField("idname5", fillSpace(certificateConference.getCertificateConferenceSubList().get(0).getName() ,10 , isNull(s,"idname5")));

        //
        s.setField("idname6", fillSpace(certificateConference.getCertificateConferenceSubList().get(0).getName() ,10 , isNull(s,"idname6")));

        //
        s.setField("idname7", fillSpace(certificateConference.getCertificateConferenceSubList().get(0).getName(),10 , isNull(s,"idname7")));

        //
        s.setField("idname8", fillSpace(certificateConference.getCertificateConferenceSubList().get(0).getName() ,10 , isNull(s,"idname8")));

        //
        s.setField("idname9", fillSpace(certificateConference.getCertificateConferenceSubList().get(0).getName() ,10 , isNull(s,"idname9")));

        //
        s.setField("idname10", fillSpace(certificateConference.getCertificateConferenceSubList().get(0).getName() ,10 , isNull(s,"idname10")));

        //
        s.setField("idname11", fillSpace(certificateConference.getCertificateConferenceSubList().get(0).getName() ,10 , isNull(s,"idname11")));

        //
        s.setField("idname12", fillSpace(certificateConference.getCertificateConferenceSubList().get(0).getName() ,10 , isNull(s,"idname12")));

        //
        s.setField("idname13", fillSpace(certificateConference.getCertificateConferenceSubList().get(0).getName() ,10 , isNull(s,"idname13")));

        //
        s.setField("idname14", fillSpace(certificateConference.getCertificateConferenceSubList().get(0).getName() ,10 , isNull(s,"idname14")));

        //
        s.setField("idname15", fillSpace(certificateConference.getCertificateConferenceSubList().get(0).getName() ,10 , isNull(s,"idname15")));

        //
        s.setField("idname16", fillSpace(certificateConference.getCertificateConferenceSubList().get(0).getName() ,10 , isNull(s,"idname16")));

        //
        s.setField("idname17", fillSpace(certificateConference.getCertificateConferenceSubList().get(0).getName() ,10 , isNull(s,"idname17")));

        //出席会议的股东所占权益总和
        s.setField("idsgSum", fillSpace(String.valueOf(sumSg) ,10 , isNull(s,"idsgSum")));

        //公司名称
        s.setField("idcompanyNameContext", fillSpace(certificateConference.getCompanyName() ,10 , isNull(s,"idcompanyNameContext")));

        //公司地址
        s.setField("idcompanyAddr", fillSpace(certificateConference.getCompanyAddr() ,10 , isNull(s,"idcompanyAddr")));

        //经营管理地址
        s.setField("idmanageAddr", fillSpace(certificateConference.getManageAddr() ,10 , isNull(s,"idmanageAddr")));

        //注册资金
        s.setField("idregisterFund", fillSpace(certificateConference.getRegisterFund() ,10 , isNull(s,"idregisterFund")));

        //股东1的出资总额
        s.setField("idtotalPrice1", fillSpace(certificateConference.getCertificateConferenceSubList().get(0).getTotalPrice() ,10 , isNull(s,"idtotalPrice1")));

        //股东1的出资权占比
        s.setField("idsg1", fillSpace(certificateConference.getCertificateConferenceSubList().get(0).getSg() ,10 , isNull(s,"idsg1")));

        //股东2的出资总额
        s.setField("idtotalPrice2", fillSpace(certificateConference.getCertificateConferenceSubList().get(0).getTotalPrice() ,10 , isNull(s,"idtotalPrice2")));

        //股东2的出资权占比
        s.setField("idsg2", fillSpace(certificateConference.getCertificateConferenceSubList().get(0).getSg() ,10 , isNull(s,"idsg2")));
